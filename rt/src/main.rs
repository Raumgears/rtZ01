...
fn main() {
    ...
    world.add(Box::new(Sphere::new(Point3::new(1.0, 0.0, -1.8),0.5, mat_diffus3)));
    world.add(Box::new(Cylinder::new( Point3::new(0.0, -0.5, -2.0), 1.0, 0.5, Vec3::new(0.0, 1.0, 0.0), mat_metal)));
